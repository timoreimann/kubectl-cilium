...
func DiscoverCiliumNamespace(ctx context.Context, kubeClient kubernetes.Interface) (string, error) {
	pp, err := kubeClient.CoreV1().Pods(corev1.NamespaceAll).List(ctx, metav1.ListOptions{
